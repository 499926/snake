...
public class PlayerSelectScreen extends JPanel {
    ...
    public PlayerSelectScreen(MainWindow mw) {
        ...
        add(opt2);
        add(opt3);
        final ActionListener actionListeneropt = new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                playerOptions();
            }
        };

        opt1.addActionListener(actionListeneropt);
        opt2.addActionListener(actionListeneropt);

        opt3.addActionListener(actionListeneropt);
