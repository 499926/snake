...
public class BoardDrawing extends JPanel {
    ...
    /**
     * BoardDrawin Este es el constructor de BoardDrawing
     * @param row fila
     * @param col columna
    ...
    /**
     * paintComponent Este es el método paintComponent
     * @param g Graphics
     */
        ...
        for (Rectangle cell : cells) {
            ...
            for (int pl = 0; pl < bs.maxPlayers; pl++) {
                if (bs.players.get(pl).getPosition() == cellnos[i]) {
                    playerColor(g2d, pl, cell, cellWidth, cellHeight);
                }
            }
    ...
    private void playerColor(Graphics2D g2d, int pl, Rectangle cell, int cellWidth, int cellHeight) {
     ...
     * @param pnos int
     * @return Mensaje de texto con la posición
     */
    ...
    /**
     * setPlayer Este es el método setPlayer
     * @param a int
     * @param pnos int
     */
